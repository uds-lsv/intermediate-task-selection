...
def main():
    ...
    for ckpt_step in checkpoint_steps:
        ...
        for i, task in enumerate(tasks):
            ...
            for j, seed in enumerate(SEEDS):
                ...
                transfer_perf = [ tgt_json_data["relative_score"][i] for i in keep_idx ]
                
                sim_values.extend(prompt_sim)
                relative_scores.extend(transfer_perf)
                print("prompt_sim",prompt_sim)
                print("transfer_perf",transfer_perf)
    ...
    print("relative_scores",relative_scores)
